...
/* NORMAL LIGHTBULD SETTINGS */
    ...
    homekit_characteristic_t lightbulb_sat                = HOMEKIT_CHARACTERISTIC_(SATURATION, (float) 0);
    homekit_characteristic_t lightbulb_hue                = HOMEKIT_CHARACTERISTIC_(HUE, (float) 180);
    ...
    HOMEKIT_ACCESSORY(.id=1, .category=homekit_accessory_category_bridge, .services=(homekit_service_t*[]) {
        ...
        // ACCESSPORIES
          ...
          HOMEKIT_ACCESSORY(.id=2, .category=homekit_accessory_category_lightbulb, .services=(homekit_service_t*[]) {
            ...
            HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
              HOMEKIT_CHARACTERISTIC(NAME, "Lampe"),
              HOMEKIT_CHARACTERISTIC(IDENTIFY, my_accessory_identify),
              NULL
            }),
